...
#include "dev_buck_ptemp_pwm.h"
#include "pwr_control/devices/dev_buck_typedef.h" // include peripheral register configuration values header
...
volatile struct P33C_PWM_GENERATOR_s buckPwmGeneratorConfig = 
{
        ...
        .PGxTRIGA.value = BUCK_ADCTRIG_DELAY,//0x0000,           // PGxTRIGA: PWM GENERATOR x TRIGGER A REGISTER
        .PGxTRIGB.value = BUCK_DAC_SLOPE_TRIG_START,//0x0000,           // PGxTRIGA: PWM GENERATOR x TRIGGER B REGISTER
        .PGxTRIGC.value = BUCK_DAC_SLOPE_TRIG_STOP,//0x0000,           // PGxTRIGA: PWM GENERATOR x TRIGGER C REGISTER
