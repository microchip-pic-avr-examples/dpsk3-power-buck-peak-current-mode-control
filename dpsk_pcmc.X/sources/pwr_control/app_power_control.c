...
volatile uint16_t appPowerSupply_ConverterObjectInitialize(void)
{
    ...
    buck.slope_comp.dac_value_initial = BUCK_DACOUT_VALUE_INITIAL; 
...
volatile uint16_t appPowerSupply_ControllerInitialize(void)
{
    ...
    buck.v_loop.minimum = BUCK_VOUT_REF_MIN;   
    buck.v_loop.maximum = BUCK_VOUT_REF_MAX;   
    ...
    buck.v_loop.controller->Ports.Target.ptrAddress = &BUCK_DACxDATH;// DACxDATH register is Control Target
