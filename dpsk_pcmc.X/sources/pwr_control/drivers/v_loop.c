...
{
    0x45800000, // Coefficient B0 will be multiplied with error input e(n-0)
    0x6B710008, // Coefficient B1 will be multiplied with error input e(n-1)
    0xBAEC0000  // Coefficient B2 will be multiplied with error input e(n-2)
};
