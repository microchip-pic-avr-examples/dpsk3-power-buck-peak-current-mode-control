...
volatile struct P33C_DAC_INSTANCE_s buckDacInstanceConfig = 
{
    ...
    .DACxDATL.value = 0x0000,       ///< DACxDATL: DACx DATA LOW REGISTER
    .DACxDATH.value = 0x0000,       ///< DACxDATH: DACx DATA HIGH REGISTER
    .SLPxCONL.value = REG_SLPxCONL, ///< SLPxCONL: DACx SLOPE CONTROL LOW REGISTER
    .SLPxCONH.value = REG_SLPxCONH, ///< SLPxCONH: DACx SLOPE CONTROL HIGH REGISTER
