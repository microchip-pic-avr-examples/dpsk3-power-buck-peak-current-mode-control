/* *********************************************************************************
 * PowerSmart™ Digital Control Library Designer, Version 0.9.14.678
 * *********************************************************************************
...
{
    0x45D7FFFF, // Coefficient A1 will be multiplied with controller output u(n-1)
    0xA2920003  // Coefficient A2 will be multiplied with controller output u(n-2)
};
